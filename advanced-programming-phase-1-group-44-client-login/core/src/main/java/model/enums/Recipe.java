...
public enum Recipe {
    FRIED_EGG("Fried Egg", Map.of("Egg", 1), 50, "Check", 10, "Starter", 35),
    ...
    TRIPLE_SHOT_ESPRESSO("Triple Shot Espresso", Map.of("Coffee", 3), 200, "100",5, "Stardrop Saloon", 450),
    COOKIE("Cookie", Map.of("Wheat Flour", 1, "Sugar", 1, "Egg", 1), 90, "", "Stardrop Saloon", 140),
    HASH_BROWNS("Hash Browns", Map.of("Potato", 1, "Oil", 1), 90, "Farming",5, "Stardrop Saloon", 120),
    PANCAKES("Pancakes", Map.of("Wheat Flour", 1, "Egg", 1), 90, "Foraging", 11, "Stardrop Saloon", 80),
    FRUIT_SALAD("Fruit Salad", Map.of("Blueberry", 1, "Melon", 1, "Apricot", 1), 263, "", "Stardrop Saloon", 450),
    RED_PLATE("Red Plate", Map.of("Red Cabbage", 1, "Radish", 1), 240, "50",3, "Stardrop Saloon", 400),
    ...
    FARMERS_LUNCH("Farmer's Lunch", Map.of("Omelet", 1, "Parsnip", 1), 200, "Farming", 5, "Farming level 1", 150),
    SURVIVAL_BURGER("Survival Burger", Map.of("Bread", 1, "Carrot", 1, "Eggplant", 1), 125, "Foraging (5 hours)", "Foraging level 3", 180),
    DISH_O_THE_SEA("Dish O' the Sea", Map.of("Sardine", 2, "Hash Browns", 1), 150, "Fishing", 5, "Fishing level 2", 220),
    SEAFOAM_PUDDING("Seaform Pudding", Map.of("Flounder", 1, "Midnight Carp", 1), 175, "Fishing", 10, "Fishing level 3", 300),
    MINERS_TREAT("Miner's Treat", Map.of("Carrot", 2, "Sugar", 1, "Milk", 1), 125, "Mining", 5, "Mining level 1", 200);
