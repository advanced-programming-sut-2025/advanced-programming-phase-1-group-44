...
public enum AnimalType {   
    ...
    duck("duck", 1200, new ArrayList<>(List.of(AnimalProductsEnum.dockEgg, AnimalProductsEnum.dockFeather)), new ArrayList<>(List.of(AnimalHomeType.bigCoop, AnimalHomeType.deluxeCoop))),
    ...
    sheep("sheep", 8000, new ArrayList<>(List.of(AnimalProductsEnum.sheetWool)), new ArrayList<>(List.of(AnimalHomeType.deluxeBarn))),
