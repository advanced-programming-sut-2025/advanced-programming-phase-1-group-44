...
public enum AllItems {
    ...
    Salmon("salmon", 75, true),
    Sardine("sardine", 40, true),
    Shad("shad", 60, true),
    BlueDiscus("blue discus", 120, true),
    MidnightCarp("midnight carp", 150, true),
    Squid("squid", 80, true),
    Tuna("tuna", 100, true),
    Perch("perch", 55, true),
    Flounder("flounder", 100, true),
    Lionfish("lionfish", 100, true),
    Herring("herring", 30, true),
    Ghostfish("ghost fish", 45, true),
    Tilapia("tilapia", 75, true),
    Dorado("dorado", 100, true),
    Sunfish("sunfish", 30, true),
    RainbowTrout("rainbow trout", 65, true),
    Legendary("legendary", 5000, true),
    Glacierfish("glacier fish", 1000, true),
    Angler("angler", 900, true),
    Crimsonfish("crimson fish", 1500, true),
    Training_Rod("training rod", 25),
